...
完整版提供 14 天完整試用。試用結束後，SanWich 會回到基本功能，核心工作仍可繼續使用。
...
完整版 Key 第一次啟用時需要連線，預設可啟用 2 台裝置；之後每 30 天重新驗證一次，另保留 14 天離線寬限。授權服務無法使用時，基本功能仍可繼續使用。
...
目前正式版更新內容見 [`docs/更新紀錄_v2.5.md`](./docs/更新紀錄_v2.5.md)。
